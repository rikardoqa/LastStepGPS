  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved usuario as @usuario" do
        ...
        post :create, {:usuario => { "login" => "invalid value" }}, valid_session
        assigns(:usuario).should be_a_new(Usuario)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested usuario" do
        ...
        Usuario.any_instance.should_receive(:update).with({ "login" => "MyString" })
        put :update, {:id => usuario.to_param, :usuario => { "login" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the usuario as @usuario" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Usuario.any_instance.stub(:save).and_return(false)
        put :update, {:id => usuario.to_param, :usuario => { "login" => "invalid value" }}, valid_session
        assigns(:usuario).should eq(usuario)
      end
